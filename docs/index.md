...
integrates BEIR with [Qdrant](https://github.com/qdrant/qdrant) - a vector search engine. The integration allows to use
Qdrant as a backend for BEIR, to test different configurations of the search engine, and to evaluate the performance of
the search engine on the BEIR datasets under different conditions.

You can, for example, test different embedding models, vector types, hybrid search pipelines, or the impact of the
quantization on the search quality.
